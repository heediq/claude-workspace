...
- **Web slices (feature/context-library-web):** A (tree/library) is next and needs nothing new merged; B/C need #48; D is chat. Kit gaps to add + gallery + README each: EmptyState, Skeleton, Tabs, Tree, Stepper, chat primitives; markdown-render dep chosen at slice D.
