...
| 2 | Role/group CRUD + audit write path | New `heediq-api` routes for roles/groups/assignments; `writeAuditEvent` helper; per-resource-type payload resolution | Implemented, PRs open awaiting merge — [heediq-shared#26](https://github.com/heediq/heediq-shared/pull/26) (`0.10.0`, published), [heediq-infra#49](https://github.com/heediq/heediq-infra/pull/49), [heediq-api#24](https://github.com/heediq/heediq-api/pull/24) | `feature/rbac-role-group-crud` (heediq-shared, heediq-api, heediq-infra) / `wip-feature-rbac-role-group-crud.md` |
