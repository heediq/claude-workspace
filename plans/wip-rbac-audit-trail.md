...
| 5 | Audit log viewer | `GET /org/audit-log` (cursor-paginated, filterable); `/org/audit-log` route in `heediq-web` | **In progress** — `heediq-infra` grant done, PR open ([#51](https://github.com/heediq/heediq-infra/pull/51)); `heediq-api` route done, PR open ([#27](https://github.com/heediq/heediq-api/pull/27)); `heediq-web` page not started (2026-07-10) | `feature/audit-log-viewer-infra`/`-api`/`-web`, see `wip-audit-log-viewer.md` |
