...
| 5 | Audit log viewer | `GET /org/audit-log` (cursor-paginated, filterable); `/org/audit-log` route in `heediq-web` | **Done** — [heediq-infra#51](https://github.com/heediq/heediq-infra/pull/51), [heediq-api#27](https://github.com/heediq/heediq-api/pull/27), [heediq-web#27](https://github.com/heediq/heediq-web/pull/27) merged 2026-07-10 | — |
